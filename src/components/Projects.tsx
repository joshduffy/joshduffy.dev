...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Anthology of 11 intentionally terrible UI games. Bad UX is the mechanic - consent dialogs, password hell, CAPTCHA nightmares, and more. Victory comes from understanding hidden rules.",
    tech: ["HTML", "CSS", "JavaScript", "Game Design"],
    status: "Live",
